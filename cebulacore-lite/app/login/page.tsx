...
export default function LoginPage() {
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      setServerError("Couldn't sign you in. Check your credentials and try again.");
    }
  }
    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4">
      ...
      <div className="glass-strong relative w-full max-w-md rounded-xl2 p-8 shadow-glow">
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <p className="mt-1 text-sm text-muted">Log in to continue building with Cebula.</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-muted">
          New to CebulaCore?{" "}
          <Link href="/register" className="font-medium text-white hover:text-glow-secondary">
            Create an account
          </Link>
        </p>
      </div>
